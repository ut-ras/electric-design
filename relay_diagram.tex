...
\begin{circuitikz}
  ...
  \draw (-2,-0.5) coordinate (R+) to ++(-1,0) to[open, o-o, v^=$24V source$]  ++(0,2) to ++(1.25,0) coordinate (R-);
  \draw (-2,-12.5) to (-2,15);
  ...
  \draw (R_1+) to[short, -o] ++(-1.5,0);
  \draw (R_1-) to[short, -o] ++(-1.25,0);
  ...
  \draw (S1-no) to ++(0,0.75) to[open, o-o, v^=$Charger_1$] ++(2,0) to (S2-no);
  \draw (S3-no) to ++(0,0.75) to[open, o-o, v^=$Charger_2$] ++(2,0) to (S4-no);
  ...
  \draw (S1-nc) to ++(0,1.75) to[open, o-o, v^=$Motor_1$] ++(2,0) to (S2-nc);
  \draw (S3-nc) to ++(0,1.75) to[open, o-o, v^=$Motor_2$] ++(2,0) to (S4-nc);

  % hook up Hoka 1 to Hoka 2 in series when in run-mode (nc)
  \draw (S5-nc) to ++(0,1.75) to ++(3.5,0) to ++(0,4.25) to (S8-nc);
  ...
  \draw (S7-nc) to ++(0,1.75) to ++(3.5,0) to ++(0,4.5) to ++(-3.5,0) to (S9-nc);
  \draw (S6-nc) to ++(1.75,0) to ++(0,12.5) to ++(-1.75,0) to (S10-nc);
